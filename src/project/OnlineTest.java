...
{  
    ...
    {  
        ...
        {  
            ...
            bk.setBounds(450,30+30*x,130,30);  
    ...
    {  
        ...
        {  
            ...
            jb[0].setText("At run time");jb[1].setText("At compile time");jb[2].setText("At coding time");
            			jb[3].setText("At execution time");  
        }  
        if(current==3)  
        {  
        ...
        if(current==4)  
        {  
            l.setText("Que5: Which of these class is superclass of String class?");  
            jb[0].setText("java.util");jb[1].setText("java.lang");jb[2].setText("ArrayList");
